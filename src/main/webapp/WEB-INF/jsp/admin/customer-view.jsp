					...
					<div class="col-md-5 border-right">
						<div class="p-3 py-5">
							...
							<form action="/admin/edit-finish" modelAttributes = "customerObj" method="post">
								<div class="row mt-2">
									<div class="col-md-6"><label class="labels">Customer ID</label><input type="number" name = "id" class="form-control" placeholder="first name" value="${customerObj.customer_id}"></div>
								...
								<div class="row mt-3">
									<div class="col-md-6"><label class="labels">Balance</label><input type="text" name = "balance" class="form-control" placeholder="" value=""></div>
								</div>
								<div class="row mt-3">
									<div class="col-md-6"><label class="labels">Loan</label><input type="text" name = "balance" class="form-control" placeholder="" value=""></div>
									<div class="col-md-6"><label class="labels">Duration</label><input type="text" name = "duration" class="form-control" placeholder="" value=""></div>
									<div class="col-md-6"><label class="labels">Loan date</label><input type="text" name = "loan-date" class="form-control" placeholder="" value=""></div>
								</div>
